! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.jekyllTabs = t() : e.jekyllTabs = t()
}(self, () => (() => {
    "use strict";
    var e = {
            296(e, t, o) {
                ...
                const a = e => {
                    ...
                    r = (e, t, o) => {
                        e.className = e.className ? `${e.className} ${t}` : t, setTimeout(() => {
                ...
                const {
                    ...
                    for (let s = 0; s < a.length; s++) {
                        const r = a[s],
                            ...
                            i = n(e);
                        let d;
                        l.style.position = "relative", i.style.position = "absolute", i.style.top = "0px", i.style.right = "0px", l.appendChild(i), t && (d = () => {
                            m(o)
    ...
    const {
        ...
        const t = {
            ...
            o = Object.assign(Object.assign(Object.assign({}, t), e), {
                copyToClipboardSettings: Object.assign(Object.assign({}, t.copyToClipboardSettings), e.copyToClipboardSettings)
            }),
            a = document.querySelectorAll("ul.tab > li > a");
        if (Array.prototype.forEach.call(a, e => {
                e.addEventListener("click", t => {
                    t.preventDefault(), r(e), o.activateTabFromUrl && s(e), o.syncTabsWithSameLabels && i(e)
                }, !1)
